...
class TestMaskFormerDecoder:
    ...
    def test_flex_local_ca_mask_equivalence(self):
        ...
        # Get mask modification function from decoder's flex_local_ca_mask method
    ...
    def test_flex_local_ca_mask_transpose_consistency(self):
        ...
        transpose_forward_mask_mod = decoder.flex_local_ca_mask(q_len, kv_len, device).transpose(-2, -1)
        transpose_mask_mod = create_mask(decoder.flex_local_ca_mask(kv_len, q_len, device))

...
class PlotEventHelper:
    ...
    def plot_evt_res(self, stylesheet=None, separate_figures=False):
        ...
        for v_i, var in enumerate(evt_vars):
            ...
            min_, max_ = np.percentile(comb, 5), np.percentile(comb, 95)
    ...
    def plot_jet_residuals(self, pt_relative=True, stylesheet=None, separate_figures=False):
        xlabel_dict = {

...
#SBATCH --mem=50G
#SBATCH --output=/share/rcif2/pduckett/hepattn-dq/src/hepattn/experiments/trackml/slurm_logs/slurm-%j.%x.out
...
# Move to workdir
cd /share/rcif2/pduckett/hepattn-dq/src/hepattn/experiments/trackml/
...
APPTAINER_CMD="apptainer run --nv --bind /share/rcif2/ /share/rcif2/pduckett/hepattn-dq/pixi.sif $PIXI_CMD"

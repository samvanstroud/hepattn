...
Instead of the standard pixi image, we need an ARM specific image. Download it from [here](https://github.com/prefix-dev/pixi-docker/pkgs/container/pixi/559545753?tag=jammy-cuda-13.0.0) via:
...
Shell into the ARM apptainer image as usual. After this install the environment that has the necessary requirements for FA3 with Grace Hopper:
